 ...
 * <ul>
 *   <li>{@link arduinoTrace.Steps.impl.BigStepImpl#getStartingState <em>Starting State</em>}</li>
 *   <li>{@link arduinoTrace.Steps.impl.BigStepImpl#getEndingState <em>Ending State</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public abstract class BigStepImpl extends MinimalEObjectImpl.Container implements BigStep {
	...
	public void setStartingState(State newStartingState) {
		if (newStartingState != startingState) {
			...
			if (startingState != null)
				msgs = ((InternalEObject)startingState).eInverseRemove(this, ArduinoTracePackage.STATE__STARTED_BIG_STEPS, State.class, msgs);
			if (newStartingState != null)
				msgs = ((InternalEObject)newStartingState).eInverseAdd(this, ArduinoTracePackage.STATE__STARTED_BIG_STEPS, State.class, msgs);
	...
	public void setEndingState(State newEndingState) {
		if (newEndingState != endingState) {
			NotificationChain msgs = null;
			if (endingState != null)
				msgs = ((InternalEObject)endingState).eInverseRemove(this, ArduinoTracePackage.STATE__ENDED_BIG_STEPS, State.class, msgs);
			if (newEndingState != null)
				msgs = ((InternalEObject)newEndingState).eInverseAdd(this, ArduinoTracePackage.STATE__ENDED_BIG_STEPS, State.class, msgs);
