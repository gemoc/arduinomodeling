...
public class Arduino_Utilities_CallImpl extends BigStepImpl implements Arduino_Utilities_Call {
	...
	public EList<Arduino_Utilities_Call_AbstractSubStep> getSubSteps() {
		if (subSteps == null) {
			subSteps = new EObjectResolvingEList<Arduino_Utilities_Call_AbstractSubStep>(Arduino_Utilities_Call_AbstractSubStep.class, this, StepsPackage.ARDUINO_UTILITIES_CALL__SUB_STEPS);
		}
		return subSteps;
	}
