...
public class Arduino_Status_CallImpl extends BigStepImpl implements Arduino_Status_Call {
	...
	public EList<Arduino_Status_Call_AbstractSubStep> getSubSteps() {
		if (subSteps == null) {
			subSteps = new EObjectResolvingEList<Arduino_Status_Call_AbstractSubStep>(Arduino_Status_Call_AbstractSubStep.class, this, StepsPackage.ARDUINO_STATUS_CALL__SUB_STEPS);
		}
		return subSteps;
	}
