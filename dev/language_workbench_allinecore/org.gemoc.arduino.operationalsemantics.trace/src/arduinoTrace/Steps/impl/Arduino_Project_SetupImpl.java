 ...
 *   <li>{@link arduinoTrace.Steps.impl.Arduino_Project_SetupImpl#getSubSteps <em>Sub Steps</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class Arduino_Project_SetupImpl extends BigStepImpl implements Arduino_Project_Setup {
	/**
	 ...
	 * @ordered
	 */
	protected EList<Arduino_Project_Setup_AbstractSubStep> subSteps;
	 ...
	 * @generated
	 */
	public EList<Arduino_Project_Setup_AbstractSubStep> getSubSteps() {
		if (subSteps == null) {
			subSteps = new EObjectResolvingEList<Arduino_Project_Setup_AbstractSubStep>(Arduino_Project_Setup_AbstractSubStep.class, this, StepsPackage.ARDUINO_PROJECT_SETUP__SUB_STEPS);
		}
		return subSteps;
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case StepsPackage.ARDUINO_PROJECT_SETUP__THIS:
				...
				return basicGetThis();
			case StepsPackage.ARDUINO_PROJECT_SETUP__SUB_STEPS:
				return getSubSteps();
		}
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			...
			case StepsPackage.ARDUINO_PROJECT_SETUP__SUB_STEPS:
				getSubSteps().clear();
				getSubSteps().addAll((Collection<? extends Arduino_Project_Setup_AbstractSubStep>)newValue);
				return;
		}
