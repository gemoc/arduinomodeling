...
public class ArduinoFactoryImpl extends EFactoryImpl implements ArduinoFactory {
	...
	public EObject create(EClass eClass) {
		switch (eClass.getClassifierID()) {
			...
			case ArduinoPackage.BOOLEAN_VALUE: return createBooleanValue();
			case ArduinoPackage.NUMBER_VALUE: return createNumberValue();
			case ArduinoPackage.STRING_VALUE: return createStringValue();
			default:
