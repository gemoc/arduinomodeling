 ...
 * <ul>
 *   <li>{@link arduinoTrace.States.impl.BooleanValue_value_ValueImpl#isValue <em>Value</em>}</li>
 *   <li>{@link arduinoTrace.States.impl.BooleanValue_value_ValueImpl#getParent <em>Parent</em>}</li>
 *   <li>{@link arduinoTrace.States.impl.BooleanValue_value_ValueImpl#getStates <em>States</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class BooleanValue_value_ValueImpl extends MinimalEObjectImpl.Container implements BooleanValue_value_Value {
	...
	public void setParent(TracedBooleanValue newParent) {
		if (newParent != eInternalContainer() || (eContainerFeatureID() != StatesPackage.BOOLEAN_VALUE_VALUE_VALUE__PARENT && newParent != null)) {
			...
			if (newParent != null)
				msgs = ((InternalEObject)newParent).eInverseAdd(this, ArduinoPackage.TRACED_BOOLEAN_VALUE__VALUE_SEQUENCE, TracedBooleanValue.class, msgs);
	...
	public NotificationChain eBasicRemoveFromContainerFeature(NotificationChain msgs) {
		switch (eContainerFeatureID()) {
			case StatesPackage.BOOLEAN_VALUE_VALUE_VALUE__PARENT:
				return eInternalContainer().eInverseRemove(this, ArduinoPackage.TRACED_BOOLEAN_VALUE__VALUE_SEQUENCE, TracedBooleanValue.class, msgs);
		}
