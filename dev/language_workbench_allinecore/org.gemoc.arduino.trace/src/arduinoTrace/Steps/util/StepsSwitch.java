	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case StepsPackage.ARDUINO_IF_EXECUTE: {
				...
				if (result == null) result = caseArduino_Utilities_Call_AbstractSubStep(arduino_If_Execute);
				if (result == null) result = caseArduino_FunctionCall_Execute_AbstractSubStep(arduino_If_Execute);
			...
			case StepsPackage.ARDUINO_SET_EXECUTE: {
				...
				if (result == null) result = caseArduino_If_Execute_AbstractSubStep(arduino_Set_Execute);
				if (result == null) result = caseSmallStep(arduino_Set_Execute);
				if (result == null) result = caseArduino_Repeat_Execute_AbstractSubStep(arduino_Set_Execute);
				if (result == null) result = caseArduino_Utilities_Call_AbstractSubStep(arduino_Set_Execute);
				if (result == null) result = caseArduino_FunctionCall_Execute_AbstractSubStep(arduino_Set_Execute);
				if (result == null) result = caseArduino_While_Execute_AbstractSubStep(arduino_Set_Execute);
				if (result == null) result = caseStep(arduino_Set_Execute);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case StepsPackage.ARDUINO_LEVEL_EXECUTE: {
				...
				if (result == null) result = caseArduino_If_Execute_AbstractSubStep(arduino_Level_Execute);
				if (result == null) result = caseSmallStep(arduino_Level_Execute);
				if (result == null) result = caseArduino_Status_Call_AbstractSubStep(arduino_Level_Execute);
				if (result == null) result = caseArduino_Repeat_Execute_AbstractSubStep(arduino_Level_Execute);
				if (result == null) result = caseArduino_Utilities_Call_AbstractSubStep(arduino_Level_Execute);
				if (result == null) result = caseArduino_FunctionCall_Execute_AbstractSubStep(arduino_Level_Execute);
				if (result == null) result = caseArduino_While_Execute_AbstractSubStep(arduino_Level_Execute);
				if (result == null) result = caseStep(arduino_Level_Execute);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case StepsPackage.ARDUINO_STATUS_EXECUTE: {
				...
				if (result == null) result = caseArduino_If_Execute_AbstractSubStep(arduino_Status_Execute);
				if (result == null) result = caseSmallStep(arduino_Status_Execute);
				if (result == null) result = caseArduino_Status_Call_AbstractSubStep(arduino_Status_Execute);
				if (result == null) result = caseArduino_Repeat_Execute_AbstractSubStep(arduino_Status_Execute);
				if (result == null) result = caseArduino_Utilities_Call_AbstractSubStep(arduino_Status_Execute);
				if (result == null) result = caseArduino_FunctionCall_Execute_AbstractSubStep(arduino_Status_Execute);
				if (result == null) result = caseArduino_While_Execute_AbstractSubStep(arduino_Status_Execute);
				if (result == null) result = caseStep(arduino_Status_Execute);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case StepsPackage.ARDUINO_DELAY_EXECUTE: {
				...
				if (result == null) result = caseArduino_Utilities_Call_AbstractSubStep(arduino_Delay_Execute);
				if (result == null) result = caseArduino_FunctionCall_Execute_AbstractSubStep(arduino_Delay_Execute);
			...
			case StepsPackage.ARDUINO_REPEAT_EXECUTE: {
				...
				if (result == null) result = caseArduino_Utilities_Call_AbstractSubStep(arduino_Repeat_Execute);
				if (result == null) result = caseArduino_FunctionCall_Execute_AbstractSubStep(arduino_Repeat_Execute);
			...
			case StepsPackage.ARDUINO_WHILE_EXECUTE: {
				...
				if (result == null) result = caseArduino_Utilities_Call_AbstractSubStep(arduino_While_Execute);
				if (result == null) result = caseArduino_FunctionCall_Execute_AbstractSubStep(arduino_While_Execute);
			...
			case StepsPackage.ARDUINO_UTILITIES_EXECUTE: {
				...
				if (result == null) result = caseArduino_Utilities_Call_AbstractSubStep(arduino_Utilities_Execute);
				if (result == null) result = caseArduino_FunctionCall_Execute_AbstractSubStep(arduino_Utilities_Execute);
			...
			case StepsPackage.ARDUINO_FUNCTION_CALL_EXECUTE: {
				...
				if (result == null) result = caseArduino_If_Execute_AbstractSubStep(arduino_FunctionCall_Execute);
				if (result == null) result = caseArduino_Repeat_Execute_AbstractSubStep(arduino_FunctionCall_Execute);
				if (result == null) result = caseArduino_Utilities_Call_AbstractSubStep(arduino_FunctionCall_Execute);
				if (result == null) result = caseBigStep(arduino_FunctionCall_Execute);
				if (result == null) result = caseArduino_FunctionCall_Execute_AbstractSubStep(arduino_FunctionCall_Execute);
				if (result == null) result = caseArduino_While_Execute_AbstractSubStep(arduino_FunctionCall_Execute);
				if (result == null) result = caseStep(arduino_FunctionCall_Execute);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case StepsPackage.ARDUINO_STATUS_CALL: {
				...
				if (result == null) result = caseArduino_FunctionCall_Execute_AbstractSubStep(arduino_Status_Call);
				if (result == null) result = caseStep(arduino_Status_Call);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			...
			case StepsPackage.ARDUINO_UTILITIES_CALL: {
				...
				if (result == null) result = caseArduino_FunctionCall_Execute_AbstractSubStep(arduino_Utilities_Call);
				if (result == null) result = caseStep(arduino_Utilities_Call);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
