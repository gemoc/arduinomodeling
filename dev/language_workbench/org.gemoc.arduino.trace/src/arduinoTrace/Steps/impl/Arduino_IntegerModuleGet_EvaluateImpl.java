...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Arduino Integer Module Get Evaluate</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link arduinoTrace.Steps.impl.Arduino_IntegerModuleGet_EvaluateImpl#getStartingState <em>Starting State</em>}</li>
 *   <li>{@link arduinoTrace.Steps.impl.Arduino_IntegerModuleGet_EvaluateImpl#getEndingState <em>Ending State</em>}</li>
 *   <li>{@link arduinoTrace.Steps.impl.Arduino_IntegerModuleGet_EvaluateImpl#getThis <em>This</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class Arduino_IntegerModuleGet_EvaluateImpl extends Arduino_ModuleAssignment_Execute_AbstractSubStepImpl implements Arduino_IntegerModuleGet_Evaluate {
	/**
	 ...
	 * @ordered
	 */
	protected IntegerModuleGet this_;
	 ...
	 * @generated
	 */
	protected Arduino_IntegerModuleGet_EvaluateImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return StepsPackage.Literals.ARDUINO_INTEGER_MODULE_GET_EVALUATE;
	}
		...
		if (startingState != null && startingState.eIsProxy()) {
			...
			if (startingState != oldStartingState) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, StepsPackage.ARDUINO_INTEGER_MODULE_GET_EVALUATE__STARTING_STATE, oldStartingState, startingState));
			}
		}
	...
	public NotificationChain basicSetStartingState(State newStartingState, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, StepsPackage.ARDUINO_INTEGER_MODULE_GET_EVALUATE__STARTING_STATE, oldStartingState, newStartingState);
	...
	public void setStartingState(State newStartingState) {
		if (newStartingState != startingState) {
			...
			eNotify(new ENotificationImpl(this, Notification.SET, StepsPackage.ARDUINO_INTEGER_MODULE_GET_EVALUATE__STARTING_STATE, newStartingState, newStartingState));
	}
	...
	public State getEndingState() {
		if (endingState != null && endingState.eIsProxy()) {
			...
			if (endingState != oldEndingState) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, StepsPackage.ARDUINO_INTEGER_MODULE_GET_EVALUATE__ENDING_STATE, oldEndingState, endingState));
			}
		}
		return endingState;
	}
	...
	public NotificationChain basicSetEndingState(State newEndingState, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, StepsPackage.ARDUINO_INTEGER_MODULE_GET_EVALUATE__ENDING_STATE, oldEndingState, newEndingState);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setEndingState(State newEndingState) {
		if (newEndingState != endingState) {
			...
			eNotify(new ENotificationImpl(this, Notification.SET, StepsPackage.ARDUINO_INTEGER_MODULE_GET_EVALUATE__ENDING_STATE, newEndingState, newEndingState));
	}
	 ...
	 * @generated
	 */
	public IntegerModuleGet getThis() {
		if (this_ != null && this_.eIsProxy()) {
			InternalEObject oldThis = (InternalEObject)this_;
			this_ = (IntegerModuleGet)eResolveProxy(oldThis);
			if (this_ != oldThis) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, StepsPackage.ARDUINO_INTEGER_MODULE_GET_EVALUATE__THIS, oldThis, this_));
			}
		}
		return this_;
	}
	 ...
	 * @generated
	 */
	public IntegerModuleGet basicGetThis() {
		return this_;
	}
	 ...
	 * @generated
	 */
	public void setThis(IntegerModuleGet newThis) {
		IntegerModuleGet oldThis = this_;
		this_ = newThis;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, StepsPackage.ARDUINO_INTEGER_MODULE_GET_EVALUATE__THIS, oldThis, this_));
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case StepsPackage.ARDUINO_INTEGER_MODULE_GET_EVALUATE__STARTING_STATE:
				if (startingState != null)
					msgs = ((InternalEObject)startingState).eInverseRemove(this, StatesPackage.STATE__STARTED_STEPS, State.class, msgs);
				return basicSetStartingState((State)otherEnd, msgs);
			case StepsPackage.ARDUINO_INTEGER_MODULE_GET_EVALUATE__ENDING_STATE:
				if (endingState != null)
					msgs = ((InternalEObject)endingState).eInverseRemove(this, StatesPackage.STATE__ENDED_STEPS, State.class, msgs);
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case StepsPackage.ARDUINO_INTEGER_MODULE_GET_EVALUATE__THIS:
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			...
			case StepsPackage.ARDUINO_INTEGER_MODULE_GET_EVALUATE__ENDING_STATE:
				...
				return;
			case StepsPackage.ARDUINO_INTEGER_MODULE_GET_EVALUATE__THIS:
				setThis((IntegerModuleGet)newValue);
				return;
		}
	...
	public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
		...
		if (baseClass == Step.class) {
			switch (derivedFeatureID) {
				case StepsPackage.ARDUINO_INTEGER_MODULE_GET_EVALUATE__STARTING_STATE: return StepsPackage.STEP__STARTING_STATE;
				case StepsPackage.ARDUINO_INTEGER_MODULE_GET_EVALUATE__ENDING_STATE: return StepsPackage.STEP__ENDING_STATE;
				default: return -1;
			}
		}
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
		...
		if (baseClass == Step.class) {
			switch (baseFeatureID) {
				case StepsPackage.STEP__STARTING_STATE: return StepsPackage.ARDUINO_INTEGER_MODULE_GET_EVALUATE__STARTING_STATE;
				case StepsPackage.STEP__ENDING_STATE: return StepsPackage.ARDUINO_INTEGER_MODULE_GET_EVALUATE__ENDING_STATE;
				default: return -1;
			}
		}
		if (baseClass == SmallStep.class) {
...
} //Arduino_IntegerModuleGet_EvaluateImpl
