...
public class ArduinoTracePackageImpl extends EPackageImpl implements ArduinoTracePackage {
	 ...
	 * @generated
	 */
	public EReference getTrace_Arduino_BooleanModuleGet_Evaluate_Sequence() {
	 ...
	 * @generated
	 */
	public EReference getTrace_Arduino_While_Execute_Sequence() {
	 ...
	 * @generated
	 */
	public EReference getTrace_Arduino_Utilities_Execute_Sequence() {
	 ...
	 * @generated
	 */
	public EReference getTrace_Arduino_IntegerModuleGet_Evaluate_Sequence() {
	 ...
	 * @generated
	 */
	public EReference getTrace_Arduino_BooleanConstant_Evaluate_Sequence() {
	 ...
	 * @generated
	 */
	public EReference getTrace_Arduino_ModuleAssignment_Call_Sequence() {
	 ...
	 * @generated
	 */
	public EReference getTrace_Arduino_IntegerConstant_Evaluate_Sequence() {
	...
	public void createPackageContents() {
		...
		createEReference(traceEClass, TRACE__ARDUINO_BOOLEAN_MODULE_GET_EVALUATE_SEQUENCE);
		createEReference(traceEClass, TRACE__ARDUINO_MODULE_ASSIGNMENT_EXECUTE_SEQUENCE);
		createEReference(traceEClass, TRACE__ARDUINO_WHILE_EXECUTE_SEQUENCE);
		createEReference(traceEClass, TRACE__ARDUINO_UTILITIES_EXECUTE_SEQUENCE);
		...
		createEReference(traceEClass, TRACE__ARDUINO_REPEAT_EXECUTE_SEQUENCE);
		createEReference(traceEClass, TRACE__ARDUINO_INTEGER_MODULE_GET_EVALUATE_SEQUENCE);
		createEReference(traceEClass, TRACE__ARDUINO_BOOLEAN_CONSTANT_EVALUATE_SEQUENCE);
		createEReference(traceEClass, TRACE__ARDUINO_MODULE_ASSIGNMENT_CALL_SEQUENCE);
		createEReference(traceEClass, TRACE__ARDUINO_INTEGER_CONSTANT_EVALUATE_SEQUENCE);
	}
	...
	public void initializePackageContents() {
		...
		initEReference(getTrace_Arduino_BooleanModuleGet_Evaluate_Sequence(), theStepsPackage.getArduino_BooleanModuleGet_Evaluate(), null, "Arduino_BooleanModuleGet_Evaluate_Sequence", null, 0, -1, Trace.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getTrace_Arduino_While_Execute_Sequence(), theStepsPackage.getArduino_While_Execute(), null, "Arduino_While_Execute_Sequence", null, 0, -1, Trace.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getTrace_Arduino_Utilities_Execute_Sequence(), theStepsPackage.getArduino_Utilities_Execute(), null, "Arduino_Utilities_Execute_Sequence", null, 0, -1, Trace.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getTrace_Arduino_Repeat_Execute_Sequence(), theStepsPackage.getArduino_Repeat_Execute(), null, "Arduino_Repeat_Execute_Sequence", null, 0, -1, Trace.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getTrace_Arduino_IntegerModuleGet_Evaluate_Sequence(), theStepsPackage.getArduino_IntegerModuleGet_Evaluate(), null, "Arduino_IntegerModuleGet_Evaluate_Sequence", null, 0, -1, Trace.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getTrace_Arduino_BooleanConstant_Evaluate_Sequence(), theStepsPackage.getArduino_BooleanConstant_Evaluate(), null, "Arduino_BooleanConstant_Evaluate_Sequence", null, 0, -1, Trace.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getTrace_Arduino_ModuleAssignment_Call_Sequence(), theStepsPackage.getArduino_ModuleAssignment_Call(), null, "Arduino_ModuleAssignment_Call_Sequence", null, 0, -1, Trace.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getTrace_Arduino_IntegerConstant_Evaluate_Sequence(), theStepsPackage.getArduino_IntegerConstant_Evaluate(), null, "Arduino_IntegerConstant_Evaluate_Sequence", null, 0, -1, Trace.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
