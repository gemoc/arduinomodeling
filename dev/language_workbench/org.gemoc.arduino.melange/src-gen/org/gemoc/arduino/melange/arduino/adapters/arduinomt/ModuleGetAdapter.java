...
public class ModuleGetAdapter extends EObjectAdapter<ModuleGet> implements org.gemoc.arduino.melange.arduinomt.arduino.ModuleGet {
  ...
  public EClass eClass() {
    return org.gemoc.arduino.melange.arduinomt.arduino.ArduinoPackage.eINSTANCE.getModuleGet();
  }
  
  @Override
  public Object eGet(final int featureID, final boolean resolve, final boolean coreType) {
    switch (featureID) {
    	case org.gemoc.arduino.melange.arduinomt.arduino.ArduinoPackage.MODULE_GET__MODULE:
    		return getModule();
    }
