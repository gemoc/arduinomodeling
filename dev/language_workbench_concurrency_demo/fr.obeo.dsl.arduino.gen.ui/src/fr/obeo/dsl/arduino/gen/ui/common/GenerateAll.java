...
public class GenerateAll {
	...
	public void doGenerate(IProgressMonitor monitor) throws IOException {
		...
		fr.obeo.dsl.arduino.gen.main.Generate gen0 = new fr.obeo.dsl.arduino.gen.main.Generate(modelURI, targetFolder.getLocation().toFile(), arguments);
		monitor.worked(1);
		String generationID = org.eclipse.acceleo.engine.utils.AcceleoLaunchingUtil.computeUIProjectID("fr.obeo.dsl.arduino.gen", "fr.obeo.dsl.arduino.gen.main.Generate", modelURI.toString(), targetFolder.getFullPath().toString(), new ArrayList<String>());
