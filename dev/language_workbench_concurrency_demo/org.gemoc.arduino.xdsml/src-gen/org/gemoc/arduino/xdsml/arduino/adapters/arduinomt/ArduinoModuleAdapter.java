...
public class ArduinoModuleAdapter extends EObjectAdapter<ArduinoModule> implements org.gemoc.arduino.xdsml.arduinomt.arduino.ArduinoModule {
  ...
  public EClass eClass() {
    return org.gemoc.arduino.xdsml.arduinomt.arduino.ArduinoPackage.eINSTANCE.getArduinoModule();
  }
  
  @Override
  public Object eGet(final int featureID, final boolean resolve, final boolean coreType) {
    switch (featureID) {
    	case org.gemoc.arduino.xdsml.arduinomt.arduino.ArduinoPackage.ARDUINO_MODULE__NAME:
    		return getName();
    	case org.gemoc.arduino.xdsml.arduinomt.arduino.ArduinoPackage.ARDUINO_MODULE__LEVEL:
    		return isLevel();
    }
