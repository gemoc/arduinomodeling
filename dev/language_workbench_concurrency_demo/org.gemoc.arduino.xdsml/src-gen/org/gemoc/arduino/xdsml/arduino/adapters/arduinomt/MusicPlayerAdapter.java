...
public class MusicPlayerAdapter extends EObjectAdapter<MusicPlayer> implements org.gemoc.arduino.xdsml.arduinomt.arduino.MusicPlayer {
  ...
  public EClass eClass() {
    return org.gemoc.arduino.xdsml.arduinomt.arduino.ArduinoPackage.eINSTANCE.getMusicPlayer();
  }
  
  @Override
  public Object eGet(final int featureID, final boolean resolve, final boolean coreType) {
    switch (featureID) {
    	case org.gemoc.arduino.xdsml.arduinomt.arduino.ArduinoPackage.MUSIC_PLAYER__NAME:
    		return getName();
    	case org.gemoc.arduino.xdsml.arduinomt.arduino.ArduinoPackage.MUSIC_PLAYER__LEVEL:
    		return isLevel();
    }
