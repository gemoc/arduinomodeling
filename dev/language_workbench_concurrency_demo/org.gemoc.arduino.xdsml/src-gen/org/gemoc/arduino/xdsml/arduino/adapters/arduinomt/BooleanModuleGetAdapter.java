...
public class BooleanModuleGetAdapter extends EObjectAdapter<BooleanModuleGet> implements org.gemoc.arduino.xdsml.arduinomt.arduino.BooleanModuleGet {
  ...
  public Object evaluate() {
    return org.gemoc.arduino.operationalsemantics.BooleanModuleGet_ExecutableAspect.evaluate(adaptee) ;
  }
  
  @Override
  public EClass eClass() {
    return org.gemoc.arduino.xdsml.arduinomt.arduino.ArduinoPackage.eINSTANCE.getBooleanModuleGet();
  }
  
  @Override
  public Object eGet(final int featureID, final boolean resolve, final boolean coreType) {
    switch (featureID) {
    	case org.gemoc.arduino.xdsml.arduinomt.arduino.ArduinoPackage.BOOLEAN_MODULE_GET__MODULE:
    		return getModule();
    }
