...
public class VariableRefAdapter extends EObjectAdapter<VariableRef> implements org.gemoc.arduino.xdsml.arduinomt.arduino.VariableRef {
  ...
  public Object evaluate() {
    return org.gemoc.arduino.operationalsemantics.VariableDeclaration_EvaluableAspect.evaluate(adaptee) ;
  }
  
  @Override
  public EClass eClass() {
    return org.gemoc.arduino.xdsml.arduinomt.arduino.ArduinoPackage.eINSTANCE.getVariableRef();
  }
  
  @Override
  public Object eGet(final int featureID, final boolean resolve, final boolean coreType) {
    switch (featureID) {
    	case org.gemoc.arduino.xdsml.arduinomt.arduino.ArduinoPackage.VARIABLE_REF__VARIABLE:
    		return getVariable();
    }
