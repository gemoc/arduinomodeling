...
public class InfraRedSensorAdapter extends EObjectAdapter<InfraRedSensor> implements org.gemoc.arduino.xdsml.arduinomt.arduino.InfraRedSensor {
  ...
  public EClass eClass() {
    return org.gemoc.arduino.xdsml.arduinomt.arduino.ArduinoPackage.eINSTANCE.getInfraRedSensor();
  }
  
  @Override
  public Object eGet(final int featureID, final boolean resolve, final boolean coreType) {
    switch (featureID) {
    	case org.gemoc.arduino.xdsml.arduinomt.arduino.ArduinoPackage.INFRA_RED_SENSOR__NAME:
    		return getName();
    	case org.gemoc.arduino.xdsml.arduinomt.arduino.ArduinoPackage.INFRA_RED_SENSOR__LEVEL:
    		return isLevel();
    }
