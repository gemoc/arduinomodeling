 ...
 * <ul>
 *   <li>{@link arduinoTrace.Steps.impl.Arduino_VariableDeclaration_ExecuteImpl#getMse <em>Mse</em>}</li>
 *   <li>{@link arduinoTrace.Steps.impl.Arduino_VariableDeclaration_ExecuteImpl#getParameters <em>Parameters</em>}</li>
 *   <li>{@link arduinoTrace.Steps.impl.Arduino_VariableDeclaration_ExecuteImpl#getResult <em>Result</em>}</li>
 *   <li>{@link arduinoTrace.Steps.impl.Arduino_VariableDeclaration_ExecuteImpl#getLogicalStep <em>Logical Step</em>}</li>
 *   <li>{@link arduinoTrace.Steps.impl.Arduino_VariableDeclaration_ExecuteImpl#getEndingState <em>Ending State</em>}</li>
 *   <li>{@link arduinoTrace.Steps.impl.Arduino_VariableDeclaration_ExecuteImpl#getStartingState <em>Starting State</em>}</li>
 *   <li>{@link arduinoTrace.Steps.impl.Arduino_VariableDeclaration_ExecuteImpl#getSubSteps <em>Sub Steps</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class Arduino_VariableDeclaration_ExecuteImpl extends Arduino_Delay_Execute_AbstractSubStepImpl implements Arduino_VariableDeclaration_Execute {
	 ...
	 * @ordered
	 */
	protected EList<Arduino_VariableDeclaration_Execute_AbstractSubStep> subSteps;
	...
	public EList<Object> getParameters() {
		if (parameters == null) {
			parameters = new EDataTypeUniqueEList<Object>(Object.class, this, StepsPackage.ARDUINO_VARIABLE_DECLARATION_EXECUTE__PARAMETERS);
		}
		return parameters;
	}
	...
	public EList<Object> getResult() {
		if (result == null) {
			result = new EDataTypeUniqueEList<Object>(Object.class, this, StepsPackage.ARDUINO_VARIABLE_DECLARATION_EXECUTE__RESULT);
		}
		return result;
	}
	 ...
	 * @generated
	 */
	public EList<Arduino_VariableDeclaration_Execute_AbstractSubStep> getSubSteps() {
		if (subSteps == null) {
			subSteps = new EObjectContainmentEList<Arduino_VariableDeclaration_Execute_AbstractSubStep>(Arduino_VariableDeclaration_Execute_AbstractSubStep.class, this, StepsPackage.ARDUINO_VARIABLE_DECLARATION_EXECUTE__SUB_STEPS);
		}
		return subSteps;
	}
