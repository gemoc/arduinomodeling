 ...
 * <ul>
 *   <li>{@link arduinoTrace.Steps.impl.Arduino_ModuleAssignment_ExecuteImpl#getMse <em>Mse</em>}</li>
 *   <li>{@link arduinoTrace.Steps.impl.Arduino_ModuleAssignment_ExecuteImpl#getParameters <em>Parameters</em>}</li>
 *   <li>{@link arduinoTrace.Steps.impl.Arduino_ModuleAssignment_ExecuteImpl#getResult <em>Result</em>}</li>
 *   <li>{@link arduinoTrace.Steps.impl.Arduino_ModuleAssignment_ExecuteImpl#getLogicalStep <em>Logical Step</em>}</li>
 *   <li>{@link arduinoTrace.Steps.impl.Arduino_ModuleAssignment_ExecuteImpl#getEndingState <em>Ending State</em>}</li>
 *   <li>{@link arduinoTrace.Steps.impl.Arduino_ModuleAssignment_ExecuteImpl#getStartingState <em>Starting State</em>}</li>
...
public class Arduino_ModuleAssignment_ExecuteImpl extends Arduino_Delay_Execute_AbstractSubStepImpl implements Arduino_ModuleAssignment_Execute {
	...
	public EList<Object> getParameters() {
		if (parameters == null) {
			parameters = new EDataTypeUniqueEList<Object>(Object.class, this, StepsPackage.ARDUINO_MODULE_ASSIGNMENT_EXECUTE__PARAMETERS);
		}
		return parameters;
	}
	...
	public EList<Object> getResult() {
		if (result == null) {
			result = new EDataTypeUniqueEList<Object>(Object.class, this, StepsPackage.ARDUINO_MODULE_ASSIGNMENT_EXECUTE__RESULT);
		}
		return result;
	}
