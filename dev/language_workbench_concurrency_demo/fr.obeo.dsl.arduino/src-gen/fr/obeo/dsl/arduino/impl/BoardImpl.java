 ...
 * <ul>
 *   <li>{@link fr.obeo.dsl.arduino.impl.BoardImpl#getProject <em>Project</em>}</li>
 *   <li>{@link fr.obeo.dsl.arduino.impl.BoardImpl#getThreads <em>Threads</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public abstract class BoardImpl extends NamedElementImpl implements Board {
	 ...
	 * @ordered
	 */
	protected EList<fr.obeo.dsl.arduino.Thread> threads;
	 ...
	 * @generated
	 */
	public EList<fr.obeo.dsl.arduino.Thread> getThreads() {
		if (threads == null) {
			threads = new EObjectResolvingEList<fr.obeo.dsl.arduino.Thread>(fr.obeo.dsl.arduino.Thread.class, this, ArduinoPackage.BOARD__THREADS);
		}
		return threads;
	}
