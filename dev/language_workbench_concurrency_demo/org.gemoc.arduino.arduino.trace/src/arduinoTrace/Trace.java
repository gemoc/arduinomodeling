 ...
 *   <li>{@link arduinoTrace.Trace#getArduino_tracedSharedResources <em>Arduino traced Shared Resources</em>}</li>
...
public interface Trace extends EObject {
	...
	/**
	 * Returns the value of the '<em><b>Arduino traced Shared Resources</b></em>' containment reference list.
	 * The list contents are of type {@link arduinoTrace.States.arduino.TracedSharedResource}.
	 * <!-- begin-user-doc -->
	 * <p>
	 * If the meaning of the '<em>Arduino traced Shared Resources</em>' containment reference list isn't clear,
	 * there really should be more of a description here...
	 * </p>
	 * <!-- end-user-doc -->
	 * @return the value of the '<em>Arduino traced Shared Resources</em>' containment reference list.
	 * @see arduinoTrace.ArduinoTracePackage#getTrace_Arduino_tracedSharedResources()
	 * @model containment="true" ordered="false"
	 * @generated
	 */
	EList<TracedSharedResource> getArduino_tracedSharedResources();
