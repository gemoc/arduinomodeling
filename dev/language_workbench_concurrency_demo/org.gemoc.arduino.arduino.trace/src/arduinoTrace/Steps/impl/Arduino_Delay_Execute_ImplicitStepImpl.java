...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Arduino Delay Execute Implicit Step</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link arduinoTrace.Steps.impl.Arduino_Delay_Execute_ImplicitStepImpl#getMse <em>Mse</em>}</li>
 *   <li>{@link arduinoTrace.Steps.impl.Arduino_Delay_Execute_ImplicitStepImpl#getParameters <em>Parameters</em>}</li>
 *   <li>{@link arduinoTrace.Steps.impl.Arduino_Delay_Execute_ImplicitStepImpl#getResult <em>Result</em>}</li>
 *   <li>{@link arduinoTrace.Steps.impl.Arduino_Delay_Execute_ImplicitStepImpl#getLogicalStep <em>Logical Step</em>}</li>
 *   <li>{@link arduinoTrace.Steps.impl.Arduino_Delay_Execute_ImplicitStepImpl#getEndingState <em>Ending State</em>}</li>
 *   <li>{@link arduinoTrace.Steps.impl.Arduino_Delay_Execute_ImplicitStepImpl#getStartingState <em>Starting State</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class Arduino_Delay_Execute_ImplicitStepImpl extends Arduino_Delay_Execute_AbstractSubStepImpl implements Arduino_Delay_Execute_ImplicitStep {
	...
	public EList<Object> getParameters() {
		if (parameters == null) {
			parameters = new EDataTypeUniqueEList<Object>(Object.class, this, StepsPackage.ARDUINO_DELAY_EXECUTE_IMPLICIT_STEP__PARAMETERS);
		}
		return parameters;
	}
	...
	public EList<Object> getResult() {
		if (result == null) {
			result = new EDataTypeUniqueEList<Object>(Object.class, this, StepsPackage.ARDUINO_DELAY_EXECUTE_IMPLICIT_STEP__RESULT);
		}
		return result;
	}
