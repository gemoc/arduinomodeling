...
public class RotationSensorAdapter extends EObjectAdapter<RotationSensor> implements org.gemoc.arduino.arduinomt.arduino.RotationSensor {
  ...
  public EClass eClass() {
    return org.gemoc.arduino.arduinomt.arduino.ArduinoPackage.eINSTANCE.getRotationSensor();
  }
  
  @Override
  public Object eGet(final int featureID, final boolean resolve, final boolean coreType) {
    switch (featureID) {
    	case org.gemoc.arduino.arduinomt.arduino.ArduinoPackage.ROTATION_SENSOR__NAME:
    		return getName();
    	case org.gemoc.arduino.arduinomt.arduino.ArduinoPackage.ROTATION_SENSOR__LEVEL:
    		return isLevel();
    }
