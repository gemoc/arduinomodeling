...
public class ProjectAdapter extends EObjectAdapter<Project> implements org.gemoc.arduino.arduinomt.arduino.Project {
  ...
  public void setBoard(final Board o) {
    if (o != null)
    	adaptee.setBoard(((org.gemoc.arduino.execarduino.adapters.arduinomt.BoardAdapter) o).getAdaptee()) ;
  ...
  public void setSketch(final Sketch o) {
    if (o != null)
    	adaptee.setSketch(((org.gemoc.arduino.execarduino.adapters.arduinomt.SketchAdapter) o).getAdaptee()) ;
