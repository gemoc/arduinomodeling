 ...
 * <ul>
 *   <li>{@link arduinoTrace.Steps.impl.Arduino_BluetoothTransceiver_PushImpl#getMse <em>Mse</em>}</li>
 *   <li>{@link arduinoTrace.Steps.impl.Arduino_BluetoothTransceiver_PushImpl#getParameters <em>Parameters</em>}</li>
 *   <li>{@link arduinoTrace.Steps.impl.Arduino_BluetoothTransceiver_PushImpl#getResult <em>Result</em>}</li>
 *   <li>{@link arduinoTrace.Steps.impl.Arduino_BluetoothTransceiver_PushImpl#getLogicalStep <em>Logical Step</em>}</li>
 *   <li>{@link arduinoTrace.Steps.impl.Arduino_BluetoothTransceiver_PushImpl#getEndingState <em>Ending State</em>}</li>
 *   <li>{@link arduinoTrace.Steps.impl.Arduino_BluetoothTransceiver_PushImpl#getStartingState <em>Starting State</em>}</li>
 *   <li>{@link arduinoTrace.Steps.impl.Arduino_BluetoothTransceiver_PushImpl#getSubSteps <em>Sub Steps</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class Arduino_BluetoothTransceiver_PushImpl extends Arduino_BluetoothTransceiver_Push_AbstractSubStepImpl implements Arduino_BluetoothTransceiver_Push {
	/**
	 ...
	 * @ordered
	 */
	protected EList<Arduino_BluetoothTransceiver_Push_AbstractSubStep> subSteps;
		...
		if (mse != null && mse.eIsProxy()) {
			...
			if (mse != oldMse) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, StepsPackage.ARDUINO_BLUETOOTH_TRANSCEIVER_PUSH__MSE, oldMse, mse));
			}
		}
		return mse;
	}
	...
	public void setMse(MSE newMse) {
		...
		mse = newMse;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, StepsPackage.ARDUINO_BLUETOOTH_TRANSCEIVER_PUSH__MSE, oldMse, mse));
	}
	...
	public EList<Object> getParameters() {
		if (parameters == null) {
			parameters = new EDataTypeUniqueEList<Object>(Object.class, this, StepsPackage.ARDUINO_BLUETOOTH_TRANSCEIVER_PUSH__PARAMETERS);
		}
		return parameters;
	}
	...
	public EList<Object> getResult() {
		if (result == null) {
			result = new EDataTypeUniqueEList<Object>(Object.class, this, StepsPackage.ARDUINO_BLUETOOTH_TRANSCEIVER_PUSH__RESULT);
		}
		return result;
	}
	...
	public LogicalStep getLogicalStep() {
		if (logicalStep != null && logicalStep.eIsProxy()) {
			...
			if (logicalStep != oldLogicalStep) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, StepsPackage.ARDUINO_BLUETOOTH_TRANSCEIVER_PUSH__LOGICAL_STEP, oldLogicalStep, logicalStep));
			}
		}
		return logicalStep;
	}
	...
	public NotificationChain basicSetLogicalStep(LogicalStep newLogicalStep, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, StepsPackage.ARDUINO_BLUETOOTH_TRANSCEIVER_PUSH__LOGICAL_STEP, oldLogicalStep, newLogicalStep);
	...
	public void setLogicalStep(LogicalStep newLogicalStep) {
		if (newLogicalStep != logicalStep) {
			...
			eNotify(new ENotificationImpl(this, Notification.SET, StepsPackage.ARDUINO_BLUETOOTH_TRANSCEIVER_PUSH__LOGICAL_STEP, newLogicalStep, newLogicalStep));
	}
	...
	public State getEndingState() {
		if (endingState != null && endingState.eIsProxy()) {
			...
			if (endingState != oldEndingState) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, StepsPackage.ARDUINO_BLUETOOTH_TRANSCEIVER_PUSH__ENDING_STATE, oldEndingState, endingState));
			}
		}
		return endingState;
	}
	...
	public NotificationChain basicSetEndingState(State newEndingState, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, StepsPackage.ARDUINO_BLUETOOTH_TRANSCEIVER_PUSH__ENDING_STATE, oldEndingState, newEndingState);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setEndingState(State newEndingState) {
		if (newEndingState != endingState) {
			...
			eNotify(new ENotificationImpl(this, Notification.SET, StepsPackage.ARDUINO_BLUETOOTH_TRANSCEIVER_PUSH__ENDING_STATE, newEndingState, newEndingState));
	}
	...
	public State getStartingState() {
		if (startingState != null && startingState.eIsProxy()) {
			...
			if (startingState != oldStartingState) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, StepsPackage.ARDUINO_BLUETOOTH_TRANSCEIVER_PUSH__STARTING_STATE, oldStartingState, startingState));
			}
		}
	...
	public NotificationChain basicSetStartingState(State newStartingState, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, StepsPackage.ARDUINO_BLUETOOTH_TRANSCEIVER_PUSH__STARTING_STATE, oldStartingState, newStartingState);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setStartingState(State newStartingState) {
		if (newStartingState != startingState) {
			...
			eNotify(new ENotificationImpl(this, Notification.SET, StepsPackage.ARDUINO_BLUETOOTH_TRANSCEIVER_PUSH__STARTING_STATE, newStartingState, newStartingState));
	}
	 ...
	 * @generated
	 */
	public EList<Arduino_BluetoothTransceiver_Push_AbstractSubStep> getSubSteps() {
		if (subSteps == null) {
			subSteps = new EObjectContainmentEList<Arduino_BluetoothTransceiver_Push_AbstractSubStep>(Arduino_BluetoothTransceiver_Push_AbstractSubStep.class, this, StepsPackage.ARDUINO_BLUETOOTH_TRANSCEIVER_PUSH__SUB_STEPS);
		}
		return subSteps;
	}
	 ...
	 * @generated
	 */
	public BluetoothTransceiver getCaller() {
		return (BluetoothTransceiver) this.getMse().getCaller();
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case StepsPackage.ARDUINO_BLUETOOTH_TRANSCEIVER_PUSH__LOGICAL_STEP:
				if (logicalStep != null)
					msgs = ((InternalEObject)logicalStep).eInverseRemove(this, MsePackage.LOGICAL_STEP__MSE_OCCURRENCES, LogicalStep.class, msgs);
				return basicSetLogicalStep((LogicalStep)otherEnd, msgs);
			case StepsPackage.ARDUINO_BLUETOOTH_TRANSCEIVER_PUSH__ENDING_STATE:
				if (endingState != null)
					msgs = ((InternalEObject)endingState).eInverseRemove(this, StatesPackage.STATE__ENDED_STEPS, State.class, msgs);
				return basicSetEndingState((State)otherEnd, msgs);
			case StepsPackage.ARDUINO_BLUETOOTH_TRANSCEIVER_PUSH__STARTING_STATE:
				if (startingState != null)
					msgs = ((InternalEObject)startingState).eInverseRemove(this, StatesPackage.STATE__STARTED_STEPS, State.class, msgs);
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			...
			case StepsPackage.ARDUINO_BLUETOOTH_TRANSCEIVER_PUSH__SUB_STEPS:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case StepsPackage.ARDUINO_BLUETOOTH_TRANSCEIVER_PUSH__MSE:
				if (resolve) return getMse();
				return basicGetMse();
			case StepsPackage.ARDUINO_BLUETOOTH_TRANSCEIVER_PUSH__PARAMETERS:
				return getParameters();
			case StepsPackage.ARDUINO_BLUETOOTH_TRANSCEIVER_PUSH__RESULT:
				return getResult();
			case StepsPackage.ARDUINO_BLUETOOTH_TRANSCEIVER_PUSH__LOGICAL_STEP:
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			...
			case StepsPackage.ARDUINO_BLUETOOTH_TRANSCEIVER_PUSH__SUB_STEPS:
				getSubSteps().clear();
				getSubSteps().addAll((Collection<? extends Arduino_BluetoothTransceiver_Push_AbstractSubStep>)newValue);
				return;
		}
	...
	public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
		if (baseClass == Arduino_Delay_Execute_AbstractSubStep.class) {
		...
		if (baseClass == MSEOccurrence.class) {
			switch (derivedFeatureID) {
				case StepsPackage.ARDUINO_BLUETOOTH_TRANSCEIVER_PUSH__MSE: return MsePackage.MSE_OCCURRENCE__MSE;
				case StepsPackage.ARDUINO_BLUETOOTH_TRANSCEIVER_PUSH__PARAMETERS: return MsePackage.MSE_OCCURRENCE__PARAMETERS;
				case StepsPackage.ARDUINO_BLUETOOTH_TRANSCEIVER_PUSH__RESULT: return MsePackage.MSE_OCCURRENCE__RESULT;
				case StepsPackage.ARDUINO_BLUETOOTH_TRANSCEIVER_PUSH__LOGICAL_STEP: return MsePackage.MSE_OCCURRENCE__LOGICAL_STEP;
				default: return -1;
			}
		}
		if (baseClass == Step.class) {
			switch (derivedFeatureID) {
				case StepsPackage.ARDUINO_BLUETOOTH_TRANSCEIVER_PUSH__ENDING_STATE: return StepsPackage.STEP__ENDING_STATE;
				case StepsPackage.ARDUINO_BLUETOOTH_TRANSCEIVER_PUSH__STARTING_STATE: return StepsPackage.STEP__STARTING_STATE;
				default: return -1;
			}
		}
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
		...
		if (baseClass == MSEOccurrence.class) {
			switch (baseFeatureID) {
				case MsePackage.MSE_OCCURRENCE__MSE: return StepsPackage.ARDUINO_BLUETOOTH_TRANSCEIVER_PUSH__MSE;
				case MsePackage.MSE_OCCURRENCE__PARAMETERS: return StepsPackage.ARDUINO_BLUETOOTH_TRANSCEIVER_PUSH__PARAMETERS;
				case MsePackage.MSE_OCCURRENCE__RESULT: return StepsPackage.ARDUINO_BLUETOOTH_TRANSCEIVER_PUSH__RESULT;
				case MsePackage.MSE_OCCURRENCE__LOGICAL_STEP: return StepsPackage.ARDUINO_BLUETOOTH_TRANSCEIVER_PUSH__LOGICAL_STEP;
				default: return -1;
			}
		}
		if (baseClass == Step.class) {
			switch (baseFeatureID) {
				case StepsPackage.STEP__ENDING_STATE: return StepsPackage.ARDUINO_BLUETOOTH_TRANSCEIVER_PUSH__ENDING_STATE;
				case StepsPackage.STEP__STARTING_STATE: return StepsPackage.ARDUINO_BLUETOOTH_TRANSCEIVER_PUSH__STARTING_STATE;
				default: return -1;
			}
		}
		if (baseClass == BigStep.class) {
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		switch (operationID) {
			case StepsPackage.ARDUINO_BLUETOOTH_TRANSCEIVER_PUSH___GET_CALLER:
				return getCaller();
		}
