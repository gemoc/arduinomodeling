 ...
 * <ul>
 *   <li>{@link arduinoTrace.Steps.impl.Arduino_VariableAssignment_ExecuteImpl#getMse <em>Mse</em>}</li>
 *   <li>{@link arduinoTrace.Steps.impl.Arduino_VariableAssignment_ExecuteImpl#getParameters <em>Parameters</em>}</li>
 *   <li>{@link arduinoTrace.Steps.impl.Arduino_VariableAssignment_ExecuteImpl#getResult <em>Result</em>}</li>
 *   <li>{@link arduinoTrace.Steps.impl.Arduino_VariableAssignment_ExecuteImpl#getLogicalStep <em>Logical Step</em>}</li>
...
public class Arduino_VariableAssignment_ExecuteImpl extends Arduino_Delay_Execute_AbstractSubStepImpl implements Arduino_VariableAssignment_Execute {
	...
	public EList<Object> getParameters() {
		if (parameters == null) {
			parameters = new EDataTypeUniqueEList<Object>(Object.class, this, StepsPackage.ARDUINO_VARIABLE_ASSIGNMENT_EXECUTE__PARAMETERS);
		}
		return parameters;
	}
	...
	public EList<Object> getResult() {
		if (result == null) {
			result = new EDataTypeUniqueEList<Object>(Object.class, this, StepsPackage.ARDUINO_VARIABLE_ASSIGNMENT_EXECUTE__RESULT);
		}
		return result;
	}
