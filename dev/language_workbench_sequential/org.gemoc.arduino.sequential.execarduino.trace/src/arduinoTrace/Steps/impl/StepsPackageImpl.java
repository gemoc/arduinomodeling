...
public class StepsPackageImpl extends EPackageImpl implements StepsPackage {
	...
	public void initializePackageContents() {
		...
		arduino_Repeat_ExecuteEClass.getESuperTypes().add(this.getArduino_Delay_Execute_AbstractSubStep());
		arduino_Repeat_ExecuteEClass.getESuperTypes().add(this.getArduino_If_Execute_AbstractSubStep());
		arduino_Repeat_ExecuteEClass.getESuperTypes().add(this.getArduino_ModuleAssignment_Execute_AbstractSubStep());
		arduino_Repeat_ExecuteEClass.getESuperTypes().add(this.getArduino_Repeat_Execute_AbstractSubStep());
		arduino_Repeat_ExecuteEClass.getESuperTypes().add(this.getArduino_VariableAssignment_Execute_AbstractSubStep());
		arduino_Repeat_ExecuteEClass.getESuperTypes().add(this.getArduino_VariableDeclaration_Execute_AbstractSubStep());
		...
		arduino_Repeat_Execute_ImplicitStepEClass.getESuperTypes().add(this.getSmallStep());
