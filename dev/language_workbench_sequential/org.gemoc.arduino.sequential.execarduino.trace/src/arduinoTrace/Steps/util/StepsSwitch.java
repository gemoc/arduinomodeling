	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case StepsPackage.ARDUINO_REPEAT_EXECUTE: {
				...
				if (result == null) result = caseArduino_Delay_Execute_AbstractSubStep(arduino_Repeat_Execute);
				if (result == null) result = caseArduino_If_Execute_AbstractSubStep(arduino_Repeat_Execute);
				if (result == null) result = caseArduino_ModuleAssignment_Execute_AbstractSubStep(arduino_Repeat_Execute);
				if (result == null) result = caseArduino_Repeat_Execute_AbstractSubStep(arduino_Repeat_Execute);
				if (result == null) result = caseArduino_VariableAssignment_Execute_AbstractSubStep(arduino_Repeat_Execute);
				if (result == null) result = caseArduino_VariableDeclaration_Execute_AbstractSubStep(arduino_Repeat_Execute);
				if (result == null) result = caseBigStep(arduino_Repeat_Execute);
				if (result == null) result = caseStep(arduino_Repeat_Execute);
				if (result == null) result = caseMSEOccurrence(arduino_Repeat_Execute);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			...
			case StepsPackage.ARDUINO_REPEAT_EXECUTE_IMPLICIT_STEP: {
				...
				if (result == null) result = caseMSEOccurrence(arduino_Repeat_Execute_ImplicitStep);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
