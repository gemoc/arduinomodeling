 ...
 * @generated
 */
public interface Arduino_Repeat_Execute extends Arduino_Delay_Execute_AbstractSubStep, Arduino_If_Execute_AbstractSubStep, Arduino_ModuleAssignment_Execute_AbstractSubStep, Arduino_Repeat_Execute_AbstractSubStep, Arduino_VariableAssignment_Execute_AbstractSubStep, Arduino_VariableDeclaration_Execute_AbstractSubStep, BigStep {
	/**
	 ...
	 *        annotation="http://www.eclipse.org/emf/2002/GenModel body='return (Repeat) this.getMse().getCaller();\n'"
	 * @generated
	 */
	Repeat getCaller();
