...
public class BooleanConstant_ExecutableAspect extends Expression_EvaluableAspect {
  ...
  public static Object evaluate(final BooleanConstant _self) {
    final org.gemoc.arduino.sequential.xarduino.aspects.BooleanConstant_ExecutableAspectBooleanConstantAspectProperties _self_ = org.gemoc.arduino.sequential.xarduino.aspects.BooleanConstant_ExecutableAspectBooleanConstantAspectContext.getSelf(_self);
    Object result = null;
     if (_self instanceof org.gemoc.arduino.sequential.xarduino.arduino.BooleanConstant){
    					result = org.gemoc.arduino.sequential.xarduino.aspects.BooleanConstant_ExecutableAspect._privk3_evaluate(_self_, (org.gemoc.arduino.sequential.xarduino.arduino.BooleanConstant)_self);
