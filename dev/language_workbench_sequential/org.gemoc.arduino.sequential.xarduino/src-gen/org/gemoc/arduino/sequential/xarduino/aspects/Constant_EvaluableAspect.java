...
public class Constant_EvaluableAspect extends Expression_EvaluableAspect {
  ...
  public static Object evaluate(final Constant _self) {
	final org.gemoc.arduino.sequential.xarduino.aspects.Constant_EvaluableAspectConstantAspectProperties _self_ = org.gemoc.arduino.sequential.xarduino.aspects.Constant_EvaluableAspectConstantAspectContext
			.getSelf(_self);
	Object result = null;
