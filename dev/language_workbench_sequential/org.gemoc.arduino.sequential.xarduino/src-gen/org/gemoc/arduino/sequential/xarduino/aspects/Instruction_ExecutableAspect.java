...
import org.gemoc.arduino.sequential.xarduino.aspects.Instruction_ExecutableAspectInstructionAspectProperties;
  ...
  public static void execute(final Instruction _self) {
    final org.gemoc.arduino.sequential.xarduino.aspects.Instruction_ExecutableAspectInstructionAspectProperties _self_ = org.gemoc.arduino.sequential.xarduino.aspects.Instruction_ExecutableAspectInstructionAspectContext.getSelf(_self);
     if (_self instanceof org.gemoc.arduino.sequential.xarduino.arduino.VariableAssignment){
    					org.gemoc.arduino.sequential.xarduino.aspects.VariableAssignment_ExecutableAspect.execute((org.gemoc.arduino.sequential.xarduino.arduino.VariableAssignment)_self);
    } else  if (_self instanceof org.gemoc.arduino.sequential.xarduino.arduino.ModuleAssignment){
    					org.gemoc.arduino.sequential.xarduino.aspects.ModuleAssignment_ExecutableAspect.execute((org.gemoc.arduino.sequential.xarduino.arduino.ModuleAssignment)_self);
    } else  if (_self instanceof org.gemoc.arduino.sequential.xarduino.arduino.If){
    					org.gemoc.arduino.sequential.xarduino.aspects.If_ExecutableAspect.execute((org.gemoc.arduino.sequential.xarduino.arduino.If)_self);
    } else  if (_self instanceof org.gemoc.arduino.sequential.xarduino.arduino.VariableDeclaration){
    					org.gemoc.arduino.sequential.xarduino.aspects.VariableDeclaration_ExecutableAspect.execute((org.gemoc.arduino.sequential.xarduino.arduino.VariableDeclaration)_self);
    } else  if (_self instanceof org.gemoc.arduino.sequential.xarduino.arduino.Repeat){
    					org.gemoc.arduino.sequential.xarduino.aspects.Repeat_ExecutableAspect.execute((org.gemoc.arduino.sequential.xarduino.arduino.Repeat)_self);
    					...
    					org.gemoc.arduino.sequential.xarduino.aspects.While_ExecutableAspect.execute((org.gemoc.arduino.sequential.xarduino.arduino.While)_self);
    					...
    					org.gemoc.arduino.sequential.xarduino.aspects.Utilities_ExecutableAspect.execute((org.gemoc.arduino.sequential.xarduino.arduino.Utilities)_self);
    } else  if (_self instanceof org.gemoc.arduino.sequential.xarduino.arduino.Instruction){
    					org.gemoc.arduino.sequential.xarduino.aspects.Instruction_ExecutableAspect._privk3_execute(_self_, (org.gemoc.arduino.sequential.xarduino.arduino.Instruction)_self);
  ...
  public static void finalize(final Instruction _self) {
    final org.gemoc.arduino.sequential.xarduino.aspects.Instruction_ExecutableAspectInstructionAspectProperties _self_ = org.gemoc.arduino.sequential.xarduino.aspects.Instruction_ExecutableAspectInstructionAspectContext.getSelf(_self);
     if (_self instanceof org.gemoc.arduino.sequential.xarduino.arduino.Repeat){
    					org.gemoc.arduino.sequential.xarduino.aspects.Repeat_EvaluableAspect.finalize((org.gemoc.arduino.sequential.xarduino.arduino.Repeat)_self);
    } else  if (_self instanceof org.gemoc.arduino.sequential.xarduino.arduino.Instruction){
    					org.gemoc.arduino.sequential.xarduino.aspects.Instruction_ExecutableAspect._privk3_finalize(_self_, (org.gemoc.arduino.sequential.xarduino.arduino.Instruction)_self);
    } else  { throw new IllegalArgumentException("Unhandled parameter types: " + java.util.Arrays.<Object>asList(_self).toString()); };
  }
