...
public class BinaryBooleanExpression_EvaluableAspect extends Expression_EvaluableAspect {
  ...
  public static Object evaluate(final BinaryBooleanExpression _self) {
    final org.gemoc.arduino.sequential.xarduino.aspects.BinaryBooleanExpression_EvaluableAspectBinaryBooleanExpressionAspectProperties _self_ = org.gemoc.arduino.sequential.xarduino.aspects.BinaryBooleanExpression_EvaluableAspectBinaryBooleanExpressionAspectContext.getSelf(_self);
    Object result = null;
     if (_self instanceof org.gemoc.arduino.sequential.xarduino.arduino.BinaryBooleanExpression){
    					result = org.gemoc.arduino.sequential.xarduino.aspects.BinaryBooleanExpression_EvaluableAspect._privk3_evaluate(_self_, (org.gemoc.arduino.sequential.xarduino.arduino.BinaryBooleanExpression)_self);
