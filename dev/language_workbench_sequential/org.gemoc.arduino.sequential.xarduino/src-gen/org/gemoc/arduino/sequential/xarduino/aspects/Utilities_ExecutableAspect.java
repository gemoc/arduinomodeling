...
public class Utilities_ExecutableAspect extends Instruction_ExecutableAspect {
  ...
  public static void execute(final Utilities _self) {
	final org.gemoc.arduino.sequential.xarduino.aspects.Utilities_ExecutableAspectUtilitiesAspectProperties _self_ = org.gemoc.arduino.sequential.xarduino.aspects.Utilities_ExecutableAspectUtilitiesAspectContext
			.getSelf(_self);
	if (_self instanceof org.gemoc.arduino.sequential.xarduino.arduino.Delay) {
		...
		org.gemoc.arduino.sequential.xarduino.aspects.Utilities_ExecutableAspect._privk3_execute(_self_,
