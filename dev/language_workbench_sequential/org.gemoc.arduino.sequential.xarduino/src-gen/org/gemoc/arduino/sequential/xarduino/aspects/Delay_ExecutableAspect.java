...
public class Delay_ExecutableAspect extends Utilities_ExecutableAspect {
  ...
  public static void execute(final Delay _self) {
    final org.gemoc.arduino.sequential.xarduino.aspects.Delay_ExecutableAspectDelayAspectProperties _self_ = org.gemoc.arduino.sequential.xarduino.aspects.Delay_ExecutableAspectDelayAspectContext.getSelf(_self);
     if (_self instanceof org.gemoc.arduino.sequential.xarduino.arduino.Delay){
    					fr.inria.diverse.k3.al.annotationprocessor.stepmanager.StepCommand command = new fr.inria.diverse.k3.al.annotationprocessor.stepmanager.StepCommand() {
    						@Override
    						public void execute() {
    							org.gemoc.arduino.sequential.xarduino.aspects.Delay_ExecutableAspect._privk3_execute(_self_, (org.gemoc.arduino.sequential.xarduino.arduino.Delay)_self);
    						}
    					};
