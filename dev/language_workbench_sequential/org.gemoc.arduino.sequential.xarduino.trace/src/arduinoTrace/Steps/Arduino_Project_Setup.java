...
public interface Arduino_Project_Setup extends SpecificStep, SmallStep {
	 ...
	 *        annotation="http://www.eclipse.org/emf/2002/GenModel body='return (org.gemoc.arduino.sequential.xarduino.arduino.Project) this.getMseoccurrence().getMse().getCaller();'"
	 * @generated
	 */
	Project getCaller();
