 ...
 * @generated
 */
public class Arduino_VariableDeclaration_ExecuteImpl extends StepImpl implements Arduino_VariableDeclaration_Execute {
	/**
	...
	public VariableDeclaration getCaller() {
		return (org.gemoc.arduino.sequential.xarduino.arduino.VariableDeclaration) this.getMseoccurrence().getMse().getCaller();
	}
