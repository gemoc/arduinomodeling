 ...
 * @generated
 */
public class Arduino_ModuleAssignment_ExecuteImpl extends StepImpl implements Arduino_ModuleAssignment_Execute {
	/**
	...
	public ModuleAssignment getCaller() {
		return (org.gemoc.arduino.sequential.xarduino.arduino.ModuleAssignment) this.getMseoccurrence().getMse().getCaller();
	}
	...
	public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
		if (baseClass == BigStep.class) {
			switch (derivedFeatureID) {
				case StepsPackage.ARDUINO_MODULE_ASSIGNMENT_EXECUTE__SUB_STEPS: return TracePackage.BIG_STEP__SUB_STEPS;
				default: return -1;
			}
		}
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
		if (baseClass == BigStep.class) {
			switch (baseFeatureID) {
				case TracePackage.BIG_STEP__SUB_STEPS: return StepsPackage.ARDUINO_MODULE_ASSIGNMENT_EXECUTE__SUB_STEPS;
				default: return -1;
			}
		}
		if (baseClass == SequentialStep.class) {
