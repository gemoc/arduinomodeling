 ...
 * @generated
 */
public class Arduino_VariableAssignment_ExecuteImpl extends StepImpl implements Arduino_VariableAssignment_Execute {
	/**
	...
	public VariableAssignment getCaller() {
		return (org.gemoc.arduino.sequential.xarduino.arduino.VariableAssignment) this.getMseoccurrence().getMse().getCaller();
	}
