 ...
 * @generated
 */
public class Arduino_Repeat_ExecuteImpl extends StepImpl implements Arduino_Repeat_Execute {
	/**
	...
	public Repeat getCaller() {
		return (org.gemoc.arduino.sequential.xarduino.arduino.Repeat) this.getMseoccurrence().getMse().getCaller();
	}
