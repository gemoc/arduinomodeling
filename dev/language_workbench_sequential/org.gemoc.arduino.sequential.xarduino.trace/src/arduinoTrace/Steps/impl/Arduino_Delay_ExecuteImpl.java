 ...
 * @generated
 */
public class Arduino_Delay_ExecuteImpl extends StepImpl implements Arduino_Delay_Execute {
	/**
	...
	public Delay getCaller() {
		return (org.gemoc.arduino.sequential.xarduino.arduino.Delay) this.getMseoccurrence().getMse().getCaller();
	}
