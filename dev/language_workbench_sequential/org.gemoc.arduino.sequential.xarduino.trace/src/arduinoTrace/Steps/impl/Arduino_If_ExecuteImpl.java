 ...
 * @generated
 */
public class Arduino_If_ExecuteImpl extends StepImpl implements Arduino_If_Execute {
	/**
	 ...
	 */
	public If getCaller() {
		return (org.gemoc.arduino.sequential.xarduino.arduino.If) this.getMseoccurrence().getMse().getCaller();
	}
