...
public interface Arduino_VariableAssignment_Execute extends Arduino_Repeat_Execute_AbstractSubStep, SpecificStep, SmallStep, Arduino_If_Execute_AbstractSubStep {
	 ...
	 *        annotation="http://www.eclipse.org/emf/2002/GenModel body='return (org.gemoc.arduino.sequential.xarduino.arduino.VariableAssignment) this.getMseoccurrence().getMse().getCaller();'"
	 * @generated
	 */
