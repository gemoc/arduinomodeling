...
public class IfAdapter extends EObjectAdapter<If> implements org.gemoc.arduino.sequential.xarduinomt.arduino.If {
  ...
  public void setElseBlock(final Block o) {
    if (o != null)
    	adaptee.setElseBlock(((org.gemoc.arduino.sequential.xarduino.adapters.xarduinomt.arduino.BlockAdapter) o).getAdaptee());
    else adaptee.setElseBlock(null);
  }
  
  @Override
  public Boolean evaluate() {
    return org.gemoc.arduino.sequential.xarduino.aspects.If_EvaluableAspect.evaluate(adaptee);
  }
  
  @Override
  public void execute() {
    org.gemoc.arduino.sequential.xarduino.aspects.If_ExecutableAspect.execute(adaptee);
  }
  ...
  public EClass eClass() {
    return org.gemoc.arduino.sequential.xarduinomt.arduino.ArduinoPackage.eINSTANCE.getIf();
  }
