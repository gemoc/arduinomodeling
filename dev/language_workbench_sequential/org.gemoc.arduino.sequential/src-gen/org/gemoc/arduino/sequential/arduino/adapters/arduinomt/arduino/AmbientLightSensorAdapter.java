...
public class AmbientLightSensorAdapter extends EObjectAdapter<AmbientLightSensor> implements org.gemoc.arduino.sequential.arduinomt.arduino.AmbientLightSensor {
  ...
  public EClass eClass() {
    return org.gemoc.arduino.sequential.arduinomt.arduino.ArduinoPackage.eINSTANCE.getAmbientLightSensor();
  }
  
  @Override
  public Object eGet(final int featureID, final boolean resolve, final boolean coreType) {
    switch (featureID) {
    	case org.gemoc.arduino.sequential.arduinomt.arduino.ArduinoPackage.AMBIENT_LIGHT_SENSOR__NAME:
    		return getName();
    }
