...
public class VariableAdapter extends EObjectAdapter<Variable> implements org.gemoc.arduino.sequential.arduinomt.arduino.Variable {
  ...
  public Object evaluate() {
    return org.gemoc.arduino.sequential.arduino.aspects.Variable_EvaluableAspect.evaluate(adaptee);
  }
  ...
  public EClass eClass() {
    return org.gemoc.arduino.sequential.arduinomt.arduino.ArduinoPackage.eINSTANCE.getVariable();
  }
  
  @Override
  public Object eGet(final int featureID, final boolean resolve, final boolean coreType) {
    switch (featureID) {
    	case org.gemoc.arduino.sequential.arduinomt.arduino.ArduinoPackage.VARIABLE__NAME:
    		return getName();
    }
