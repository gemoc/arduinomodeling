...
/**
 * This is the item provider adapter for a {@link org.gemoc.arduino.concurrent.xarduino.arduino.BooleanVariable} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class BooleanVariableItemProvider extends VariableItemProvider {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 org.gemoc.arduino.concurrent.xarduino.arduino.ArduinoPackage.Literals.BOOLEAN_VARIABLE__INITIAL_VALUE,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 org.gemoc.arduino.concurrent.xarduino.arduino.ArduinoPackage.Literals.BOOLEAN_VARIABLE__VALUE,
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		String label = ((org.gemoc.arduino.concurrent.xarduino.arduino.BooleanVariable)object).getName();
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(org.gemoc.arduino.concurrent.xarduino.arduino.BooleanVariable.class)) {
			case org.gemoc.arduino.concurrent.xarduino.arduino.ArduinoPackage.BOOLEAN_VARIABLE__INITIAL_VALUE:
			case org.gemoc.arduino.concurrent.xarduino.arduino.ArduinoPackage.BOOLEAN_VARIABLE__VALUE:
