...
/**
 * This is the item provider adapter for a {@link org.gemoc.arduino.concurrent.xarduino.arduino.IntegerVariable} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class IntegerVariableItemProvider extends VariableItemProvider {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 org.gemoc.arduino.concurrent.xarduino.arduino.ArduinoPackage.Literals.INTEGER_VARIABLE__INITIAL_VALUE,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 org.gemoc.arduino.concurrent.xarduino.arduino.ArduinoPackage.Literals.INTEGER_VARIABLE__VALUE,
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		String label = ((org.gemoc.arduino.concurrent.xarduino.arduino.IntegerVariable)object).getName();
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(org.gemoc.arduino.concurrent.xarduino.arduino.IntegerVariable.class)) {
			case org.gemoc.arduino.concurrent.xarduino.arduino.ArduinoPackage.INTEGER_VARIABLE__INITIAL_VALUE:
			case org.gemoc.arduino.concurrent.xarduino.arduino.ArduinoPackage.INTEGER_VARIABLE__VALUE:
