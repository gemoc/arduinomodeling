...
public class XArduinoCodeExecutor extends CodeExecutorDispatcher 
	...
	public XArduinoCodeExecutor(){
		...
		addExecutor(new org.gemoc.execution.concurrent.ccsljavaengine.extensions.k3.dsa.impl.MelangeCodeExecutor(this,
			"org.gemoc.arduino.concurrent.XArduino"));
