...
public class FanAdapter extends EObjectAdapter<Fan> implements org.gemoc.arduino.concurrent.arduinoconcurrentmt.arduino.Fan {
  ...
  public EClass eClass() {
    return org.gemoc.arduino.concurrent.arduinoconcurrentmt.arduino.ArduinoPackage.eINSTANCE.getFan();
  }
  
  @Override
  public Object eGet(final int featureID, final boolean resolve, final boolean coreType) {
    switch (featureID) {
    	case org.gemoc.arduino.concurrent.arduinoconcurrentmt.arduino.ArduinoPackage.FAN__NAME:
    		return getName();
    }
