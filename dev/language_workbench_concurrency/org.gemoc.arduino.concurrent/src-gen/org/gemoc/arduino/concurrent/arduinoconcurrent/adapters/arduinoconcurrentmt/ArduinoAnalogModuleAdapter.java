...
public class ArduinoAnalogModuleAdapter extends EObjectAdapter<ArduinoAnalogModule> implements org.gemoc.arduino.concurrent.arduinoconcurrentmt.arduino.ArduinoAnalogModule {
  ...
  public EClass eClass() {
    return org.gemoc.arduino.concurrent.arduinoconcurrentmt.arduino.ArduinoPackage.eINSTANCE.getArduinoAnalogModule();
  }
  
  @Override
  public Object eGet(final int featureID, final boolean resolve, final boolean coreType) {
    switch (featureID) {
    	case org.gemoc.arduino.concurrent.arduinoconcurrentmt.arduino.ArduinoPackage.ARDUINO_ANALOG_MODULE__NAME:
    		return getName();
    }
