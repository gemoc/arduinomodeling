...
public class MusicPlayerAdapter extends EObjectAdapter<MusicPlayer> implements org.gemoc.arduino.concurrent.arduinoconcurrentmt.arduino.MusicPlayer {
  ...
  public EClass eClass() {
    return org.gemoc.arduino.concurrent.arduinoconcurrentmt.arduino.ArduinoPackage.eINSTANCE.getMusicPlayer();
  }
  
  @Override
  public Object eGet(final int featureID, final boolean resolve, final boolean coreType) {
    switch (featureID) {
    	case org.gemoc.arduino.concurrent.arduinoconcurrentmt.arduino.ArduinoPackage.MUSIC_PLAYER__NAME:
    		return getName();
    }
