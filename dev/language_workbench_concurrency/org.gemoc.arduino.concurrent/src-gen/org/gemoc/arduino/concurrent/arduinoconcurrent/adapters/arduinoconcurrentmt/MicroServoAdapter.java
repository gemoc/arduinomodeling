...
public class MicroServoAdapter extends EObjectAdapter<MicroServo> implements org.gemoc.arduino.concurrent.arduinoconcurrentmt.arduino.MicroServo {
  ...
  public EClass eClass() {
    return org.gemoc.arduino.concurrent.arduinoconcurrentmt.arduino.ArduinoPackage.eINSTANCE.getMicroServo();
  }
  
  @Override
  public Object eGet(final int featureID, final boolean resolve, final boolean coreType) {
    switch (featureID) {
    	case org.gemoc.arduino.concurrent.arduinoconcurrentmt.arduino.ArduinoPackage.MICRO_SERVO__NAME:
    		return getName();
    }
