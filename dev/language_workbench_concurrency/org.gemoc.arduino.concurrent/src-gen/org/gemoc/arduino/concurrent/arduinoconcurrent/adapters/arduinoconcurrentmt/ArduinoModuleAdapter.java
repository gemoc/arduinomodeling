...
public class ArduinoModuleAdapter extends EObjectAdapter<ArduinoModule> implements org.gemoc.arduino.concurrent.arduinoconcurrentmt.arduino.ArduinoModule {
  ...
  public EClass eClass() {
    return org.gemoc.arduino.concurrent.arduinoconcurrentmt.arduino.ArduinoPackage.eINSTANCE.getArduinoModule();
  }
  
  @Override
  public Object eGet(final int featureID, final boolean resolve, final boolean coreType) {
    switch (featureID) {
    	case org.gemoc.arduino.concurrent.arduinoconcurrentmt.arduino.ArduinoPackage.ARDUINO_MODULE__NAME:
    		return getName();
    }
