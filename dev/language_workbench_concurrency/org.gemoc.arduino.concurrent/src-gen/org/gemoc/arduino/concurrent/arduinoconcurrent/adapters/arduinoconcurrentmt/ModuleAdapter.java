...
public class ModuleAdapter extends EObjectAdapter<Module> implements org.gemoc.arduino.concurrent.arduinoconcurrentmt.arduino.Module {
  ...
  public EClass eClass() {
    return org.gemoc.arduino.concurrent.arduinoconcurrentmt.arduino.ArduinoPackage.eINSTANCE.getModule();
  }
  
  @Override
  public Object eGet(final int featureID, final boolean resolve, final boolean coreType) {
    switch (featureID) {
    	case org.gemoc.arduino.concurrent.arduinoconcurrentmt.arduino.ArduinoPackage.MODULE__NAME:
    		return getName();
    }
