...
public class InfraRedSensorAdapter extends EObjectAdapter<InfraRedSensor> implements org.gemoc.arduino.concurrent.arduinoconcurrentmt.arduino.InfraRedSensor {
  ...
  public EClass eClass() {
    return org.gemoc.arduino.concurrent.arduinoconcurrentmt.arduino.ArduinoPackage.eINSTANCE.getInfraRedSensor();
  }
  
  @Override
  public Object eGet(final int featureID, final boolean resolve, final boolean coreType) {
    switch (featureID) {
    	case org.gemoc.arduino.concurrent.arduinoconcurrentmt.arduino.ArduinoPackage.INFRA_RED_SENSOR__NAME:
    		return getName();
    }
