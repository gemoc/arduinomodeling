...
public class AmbientLightSensorAdapter extends EObjectAdapter<AmbientLightSensor> implements org.gemoc.arduino.concurrent.arduinoconcurrentmt.arduino.AmbientLightSensor {
  ...
  public EClass eClass() {
    return org.gemoc.arduino.concurrent.arduinoconcurrentmt.arduino.ArduinoPackage.eINSTANCE.getAmbientLightSensor();
  }
  
  @Override
  public Object eGet(final int featureID, final boolean resolve, final boolean coreType) {
    switch (featureID) {
    	case org.gemoc.arduino.concurrent.arduinoconcurrentmt.arduino.ArduinoPackage.AMBIENT_LIGHT_SENSOR__NAME:
    		return getName();
    }
