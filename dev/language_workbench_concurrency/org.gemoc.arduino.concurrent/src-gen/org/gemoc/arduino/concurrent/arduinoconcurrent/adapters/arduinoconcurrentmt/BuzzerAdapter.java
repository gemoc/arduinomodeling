...
public class BuzzerAdapter extends EObjectAdapter<Buzzer> implements org.gemoc.arduino.concurrent.arduinoconcurrentmt.arduino.Buzzer {
  ...
  public EClass eClass() {
    return org.gemoc.arduino.concurrent.arduinoconcurrentmt.arduino.ArduinoPackage.eINSTANCE.getBuzzer();
  }
  
  @Override
  public Object eGet(final int featureID, final boolean resolve, final boolean coreType) {
    switch (featureID) {
    	case org.gemoc.arduino.concurrent.arduinoconcurrentmt.arduino.ArduinoPackage.BUZZER__NAME:
    		return getName();
    }
