...
public class VariableAdapter extends EObjectAdapter<Variable> implements org.gemoc.arduino.concurrent.arduinoconcurrentmt.arduino.Variable {
  ...
  public Object evaluate() {
    return org.gemoc.arduino.concurrent.operationalsemantics.Variable_EvaluableAspect.evaluate(adaptee) ;
  }
  ...
  public EClass eClass() {
    return org.gemoc.arduino.concurrent.arduinoconcurrentmt.arduino.ArduinoPackage.eINSTANCE.getVariable();
  }
  
  @Override
  public Object eGet(final int featureID, final boolean resolve, final boolean coreType) {
    switch (featureID) {
    	case org.gemoc.arduino.concurrent.arduinoconcurrentmt.arduino.ArduinoPackage.VARIABLE__NAME:
    		return getName();
    }
