...
public class SoundSensorAdapter extends EObjectAdapter<SoundSensor> implements org.gemoc.arduino.concurrent.arduinoconcurrentmt.arduino.SoundSensor {
  ...
  public EClass eClass() {
    return org.gemoc.arduino.concurrent.arduinoconcurrentmt.arduino.ArduinoPackage.eINSTANCE.getSoundSensor();
  }
  
  @Override
  public Object eGet(final int featureID, final boolean resolve, final boolean coreType) {
    switch (featureID) {
    	case org.gemoc.arduino.concurrent.arduinoconcurrentmt.arduino.ArduinoPackage.SOUND_SENSOR__NAME:
    		return getName();
    }
