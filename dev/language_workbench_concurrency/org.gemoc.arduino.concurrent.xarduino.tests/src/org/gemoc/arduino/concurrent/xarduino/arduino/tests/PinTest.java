 ...
 * @generated
 */
public abstract class PinTest extends NamedElementTest {
	 ...
	 */
	@Override
	protected org.gemoc.arduino.concurrent.xarduino.arduino.Pin getFixture() {
		return (org.gemoc.arduino.concurrent.xarduino.arduino.Pin)fixture;
	}
