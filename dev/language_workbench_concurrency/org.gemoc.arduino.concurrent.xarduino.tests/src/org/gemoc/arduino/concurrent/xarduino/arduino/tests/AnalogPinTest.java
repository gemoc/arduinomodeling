...
public class AnalogPinTest extends PinTest {
	 ...
	 */
	@Override
	protected org.gemoc.arduino.concurrent.xarduino.arduino.AnalogPin getFixture() {
		return (org.gemoc.arduino.concurrent.xarduino.arduino.AnalogPin)fixture;
	}
	...
	protected void setUp() throws Exception {
		setFixture(org.gemoc.arduino.concurrent.xarduino.arduino.ArduinoFactory.eINSTANCE.createAnalogPin());
	}
