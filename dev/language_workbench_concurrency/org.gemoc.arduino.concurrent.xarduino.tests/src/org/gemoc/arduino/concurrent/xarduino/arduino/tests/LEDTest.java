...
public class LEDTest extends ArduinoDigitalModuleTest {
	 ...
	 */
	@Override
	protected org.gemoc.arduino.concurrent.xarduino.arduino.LED getFixture() {
		return (org.gemoc.arduino.concurrent.xarduino.arduino.LED)fixture;
	}
	...
	protected void setUp() throws Exception {
		setFixture(org.gemoc.arduino.concurrent.xarduino.arduino.ArduinoFactory.eINSTANCE.createLED());
	}
