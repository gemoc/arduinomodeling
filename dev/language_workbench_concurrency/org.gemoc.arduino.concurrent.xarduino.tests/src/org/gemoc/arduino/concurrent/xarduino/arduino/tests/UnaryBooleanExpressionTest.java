...
public class UnaryBooleanExpressionTest extends UnaryExpressionTest {
	 ...
	 */
	@Override
	protected org.gemoc.arduino.concurrent.xarduino.arduino.UnaryBooleanExpression getFixture() {
		return (org.gemoc.arduino.concurrent.xarduino.arduino.UnaryBooleanExpression)fixture;
	}
	...
	protected void setUp() throws Exception {
		setFixture(org.gemoc.arduino.concurrent.xarduino.arduino.ArduinoFactory.eINSTANCE.createUnaryBooleanExpression());
	}
