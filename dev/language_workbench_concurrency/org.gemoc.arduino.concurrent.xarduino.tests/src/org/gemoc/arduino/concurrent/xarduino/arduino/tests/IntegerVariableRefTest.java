...
public class IntegerVariableRefTest extends VariableRefTest {
	 ...
	 */
	@Override
	protected org.gemoc.arduino.concurrent.xarduino.arduino.IntegerVariableRef getFixture() {
		return (org.gemoc.arduino.concurrent.xarduino.arduino.IntegerVariableRef)fixture;
	}
	...
	protected void setUp() throws Exception {
		setFixture(org.gemoc.arduino.concurrent.xarduino.arduino.ArduinoFactory.eINSTANCE.createIntegerVariableRef());
	}
