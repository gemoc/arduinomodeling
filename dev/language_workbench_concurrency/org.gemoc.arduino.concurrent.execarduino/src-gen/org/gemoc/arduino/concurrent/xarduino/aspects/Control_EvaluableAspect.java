  ...
  public static Boolean evaluate(final Control _self) {
    ...
    Object result = null;
     if (_self instanceof org.gemoc.arduino.concurrent.xarduino.arduino.Repeat){
    					result = org.gemoc.arduino.concurrent.xarduino.aspects.Repeat_EvaluableAspect.evaluate((org.gemoc.arduino.concurrent.xarduino.arduino.Repeat)_self);
    } else  if (_self instanceof org.gemoc.arduino.concurrent.xarduino.arduino.If){
    					result = org.gemoc.arduino.concurrent.xarduino.aspects.If_EvaluableAspect.evaluate((org.gemoc.arduino.concurrent.xarduino.arduino.If)_self);
    } else  if (_self instanceof org.gemoc.arduino.concurrent.xarduino.arduino.While){
    					result = org.gemoc.arduino.concurrent.xarduino.aspects.While_EvaluableAspect.evaluate((org.gemoc.arduino.concurrent.xarduino.arduino.While)_self);
    } else  if (_self instanceof org.gemoc.arduino.concurrent.xarduino.arduino.Control){
    					result = org.gemoc.arduino.concurrent.xarduino.aspects.Control_EvaluableAspect._privk3_evaluate(_self_, (org.gemoc.arduino.concurrent.xarduino.arduino.Control)_self);
