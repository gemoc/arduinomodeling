  ...
  public static void execute(final Instruction _self) {
    final org.gemoc.arduino.concurrent.xarduino.aspects.Instruction_ExecutableAspectInstructionAspectProperties _self_ = org.gemoc.arduino.concurrent.xarduino.aspects.Instruction_ExecutableAspectInstructionAspectContext.getSelf(_self);
     if (_self instanceof org.gemoc.arduino.concurrent.xarduino.arduino.ModuleAssignment){
    					org.gemoc.arduino.concurrent.xarduino.aspects.ModuleAssignment_ExecutableAspect.execute((org.gemoc.arduino.concurrent.xarduino.arduino.ModuleAssignment)_self);
    } else  if (_self instanceof org.gemoc.arduino.concurrent.xarduino.arduino.Control){
    					org.gemoc.arduino.concurrent.xarduino.aspects.Control_ExecutableAspect.execute((org.gemoc.arduino.concurrent.xarduino.arduino.Control)_self);
    } else  if (_self instanceof org.gemoc.arduino.concurrent.xarduino.arduino.Delay){
    					org.gemoc.arduino.concurrent.xarduino.aspects.Delay_ExecutableAspect.execute((org.gemoc.arduino.concurrent.xarduino.arduino.Delay)_self);
    ...
    } else  if (_self instanceof org.gemoc.arduino.concurrent.xarduino.arduino.VariableDeclaration){
    					org.gemoc.arduino.concurrent.xarduino.aspects.VariableDeclaration_ExecutableAspect.execute((org.gemoc.arduino.concurrent.xarduino.arduino.VariableDeclaration)_self);
    } else  if (_self instanceof org.gemoc.arduino.concurrent.xarduino.arduino.VariableAssignment){
    					org.gemoc.arduino.concurrent.xarduino.aspects.VariableAssignment_ExecutableAspect.execute((org.gemoc.arduino.concurrent.xarduino.arduino.VariableAssignment)_self);
    					...
    					org.gemoc.arduino.concurrent.xarduino.aspects.Instruction_ExecutableAspect._privk3_execute(_self_, (org.gemoc.arduino.concurrent.xarduino.arduino.Instruction)_self);
  ...
  public static void finalize(final Instruction _self) {
    final org.gemoc.arduino.concurrent.xarduino.aspects.Instruction_ExecutableAspectInstructionAspectProperties _self_ = org.gemoc.arduino.concurrent.xarduino.aspects.Instruction_ExecutableAspectInstructionAspectContext.getSelf(_self);
     if (_self instanceof org.gemoc.arduino.concurrent.xarduino.arduino.Repeat){
    					org.gemoc.arduino.concurrent.xarduino.aspects.Repeat_EvaluableAspect.finalize((org.gemoc.arduino.concurrent.xarduino.arduino.Repeat)_self);
    } else  if (_self instanceof org.gemoc.arduino.concurrent.xarduino.arduino.Instruction){
    					org.gemoc.arduino.concurrent.xarduino.aspects.Instruction_ExecutableAspect._privk3_finalize(_self_, (org.gemoc.arduino.concurrent.xarduino.arduino.Instruction)_self);
    } else  { throw new IllegalArgumentException("Unhandled parameter types: " + java.util.Arrays.<Object>asList(_self).toString()); };
  }
