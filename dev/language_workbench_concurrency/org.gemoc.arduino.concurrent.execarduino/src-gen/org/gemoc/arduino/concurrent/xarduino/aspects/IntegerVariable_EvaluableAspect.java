...
import org.gemoc.arduino.concurrent.xarduino.aspects.IntegerVariable_EvaluableAspectIntegerVariableAspectProperties;
import org.gemoc.arduino.concurrent.xarduino.aspects.Variable_EvaluableAspect;
...
public class IntegerVariable_EvaluableAspect extends Variable_EvaluableAspect {
  ...
  public static Object evaluate(final IntegerVariable _self) {
    final org.gemoc.arduino.concurrent.xarduino.aspects.IntegerVariable_EvaluableAspectIntegerVariableAspectProperties _self_ = org.gemoc.arduino.concurrent.xarduino.aspects.IntegerVariable_EvaluableAspectIntegerVariableAspectContext.getSelf(_self);
    Object result = null;
     if (_self instanceof org.gemoc.arduino.concurrent.xarduino.arduino.IntegerVariable){
    					result = org.gemoc.arduino.concurrent.xarduino.aspects.IntegerVariable_EvaluableAspect._privk3_evaluate(_self_, (org.gemoc.arduino.concurrent.xarduino.arduino.IntegerVariable)_self);
    } else  if (_self instanceof org.gemoc.arduino.concurrent.xarduino.arduino.Variable){
    					result = org.gemoc.arduino.concurrent.xarduino.aspects.Variable_EvaluableAspect.evaluate((org.gemoc.arduino.concurrent.xarduino.arduino.Variable)_self);
