...
public class WhileTest extends ControlTest {
	 ...
	 */
	@Override
	protected org.gemoc.arduino.concurrent.xarduino.arduino.While getFixture() {
		return (org.gemoc.arduino.concurrent.xarduino.arduino.While)fixture;
	}
	...
	protected void setUp() throws Exception {
		setFixture(org.gemoc.arduino.concurrent.xarduino.arduino.ArduinoFactory.eINSTANCE.createWhile());
	}
