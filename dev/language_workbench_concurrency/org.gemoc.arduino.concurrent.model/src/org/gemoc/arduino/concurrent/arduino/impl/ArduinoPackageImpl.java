...
import org.gemoc.arduino.concurrent.arduino.AmbientLightSensor;
import org.gemoc.arduino.concurrent.arduino.AnalogPin;
import org.gemoc.arduino.concurrent.arduino.ArduinoAnalogModule;
...
import org.gemoc.arduino.concurrent.arduino.ArduinoDigitalModule;
import org.gemoc.arduino.concurrent.arduino.ArduinoFactory;
import org.gemoc.arduino.concurrent.arduino.ArduinoModule;
import org.gemoc.arduino.concurrent.arduino.ArduinoPackage;
import org.gemoc.arduino.concurrent.arduino.Assignment;
import org.gemoc.arduino.concurrent.arduino.BinaryBooleanExpression;
import org.gemoc.arduino.concurrent.arduino.BinaryBooleanOperatorKind;
...
import org.gemoc.arduino.concurrent.arduino.BinaryIntegerOperatorKind;
import org.gemoc.arduino.concurrent.arduino.Block;
import org.gemoc.arduino.concurrent.arduino.BluetoothTransceiver;
import org.gemoc.arduino.concurrent.arduino.Board;
...
import org.gemoc.arduino.concurrent.arduino.Buzzer;
import org.gemoc.arduino.concurrent.arduino.Color;
...
import org.gemoc.arduino.concurrent.arduino.DigitalPin;
import org.gemoc.arduino.concurrent.arduino.Expression;
import org.gemoc.arduino.concurrent.arduino.Fan;
import org.gemoc.arduino.concurrent.arduino.If;
import org.gemoc.arduino.concurrent.arduino.InfraRedSensor;
...
import org.gemoc.arduino.concurrent.arduino.MicroServo;
...
import org.gemoc.arduino.concurrent.arduino.MusicPlayer;
import org.gemoc.arduino.concurrent.arduino.NamedElement;
...
import org.gemoc.arduino.concurrent.arduino.RotationSensor;
import org.gemoc.arduino.concurrent.arduino.Sketch;
import org.gemoc.arduino.concurrent.arduino.SoundSensor;
import org.gemoc.arduino.concurrent.arduino.Time;
import org.gemoc.arduino.concurrent.arduino.UnaryBooleanExpression;
import org.gemoc.arduino.concurrent.arduino.UnaryBooleanOperatorKind;
import org.gemoc.arduino.concurrent.arduino.UnaryExpression;
import org.gemoc.arduino.concurrent.arduino.UnaryIntegerExpression;
import org.gemoc.arduino.concurrent.arduino.UnaryIntegerOperatorKind;
...
public class ArduinoPackageImpl extends EPackageImpl implements ArduinoPackage {
	 ...
	 * @see org.gemoc.arduino.concurrent.arduino.ArduinoPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	...
	public void initializePackageContents() {
		...
		moduleGetEClass.getESuperTypes().add(this.getModuleInstruction());
		...
		arduinoCommunicationModuleEClass.getESuperTypes().add(this.getArduinoAnalogModule());
		...
		initEClass(moduleEClass, org.gemoc.arduino.concurrent.arduino.Module.class, "Module", IS_ABSTRACT, IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		...
		initEClass(ledEClass, org.gemoc.arduino.concurrent.arduino.LED.class, "LED", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
