 ...
 * </p>
 * <ul>
 *   <li>{@link org.gemoc.arduino.concurrent.arduino.Repeat#getIteration <em>Iteration</em>}</li>
 * </ul>
 *
 * @see org.gemoc.arduino.concurrent.arduino.ArduinoPackage#getRepeat()
 * @model
 * @generated
 */
public interface Repeat extends Control {
	 ...
	 * @see org.gemoc.arduino.concurrent.arduino.ArduinoPackage#getRepeat_Iteration()
	 * @model default="5"
	 * @generated
	 */
	int getIteration();
	...
	/**
	 * Sets the value of the '{@link org.gemoc.arduino.concurrent.arduino.Repeat#getIteration <em>Iteration</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
