...
public class ArduinoSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case ArduinoPackage.MODULE: {
				org.gemoc.arduino.concurrent.xarduino.arduino.Module module = (org.gemoc.arduino.concurrent.xarduino.arduino.Module)theEObject;
			...
			case ArduinoPackage.MODULE_GET: {
				...
				if (result == null) result = caseModuleInstruction(moduleGet);
				if (result == null) result = caseInstruction(moduleGet);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			...
			case ArduinoPackage.BOOLEAN_MODULE_GET: {
				...
				if (result == null) result = caseModuleInstruction(booleanModuleGet);
				if (result == null) result = caseInstruction(booleanModuleGet);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ArduinoPackage.INTEGER_MODULE_GET: {
				...
				if (result == null) result = caseModuleInstruction(integerModuleGet);
				if (result == null) result = caseInstruction(integerModuleGet);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
	 ...
	 * @generated
	 */
	public T caseModule(org.gemoc.arduino.concurrent.xarduino.arduino.Module object) {
		return null;
	}
