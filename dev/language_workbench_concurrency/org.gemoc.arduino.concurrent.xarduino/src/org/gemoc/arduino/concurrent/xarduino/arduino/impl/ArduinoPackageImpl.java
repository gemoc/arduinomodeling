...
public class ArduinoPackageImpl extends EPackageImpl implements ArduinoPackage {
	 ...
	 * @see org.gemoc.arduino.concurrent.xarduino.arduino.ArduinoPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	...
	public void createPackageContents() {
		...
		createEAttribute(repeatEClass, REPEAT__I);
	...
	public void initializePackageContents() {
		...
		initEAttribute(getRepeat_I(), ecorePackage.getEIntegerObject(), "i", null, 0, 1, Repeat.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, !IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEClass(ledEClass, org.gemoc.arduino.concurrent.xarduino.arduino.LED.class, "LED", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getLED_Color(), this.getColor(), "color", "blue", 1, 1, org.gemoc.arduino.concurrent.xarduino.arduino.LED.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(pushButtonEClass, PushButton.class, "PushButton", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getPushButton_IsPushed(), ecorePackage.getEBoolean(), "isPushed", null, 0, 1, PushButton.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, !IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
