...
public class Constant_EvaluableAspect extends Expression_EvaluableAspect {
  ...
  public static Object evaluate(final Constant _self) {
    final org.gemoc.arduino.concurrent.xarduino.aspects.Constant_EvaluableAspectConstantAspectProperties _self_ = org.gemoc.arduino.concurrent.xarduino.aspects.Constant_EvaluableAspectConstantAspectContext.getSelf(_self);
    Object result = null;
     if (_self instanceof org.gemoc.arduino.concurrent.xarduino.arduino.Constant){
    					result = org.gemoc.arduino.concurrent.xarduino.aspects.Constant_EvaluableAspect._privk3_evaluate(_self_, (org.gemoc.arduino.concurrent.xarduino.arduino.Constant)_self);
