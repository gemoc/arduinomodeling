...
public class IntegerConstant_ExecutableAspect extends Expression_EvaluableAspect {
  ...
  public static Object evaluate(final IntegerConstant _self) {
    final org.gemoc.arduino.concurrent.xarduino.aspects.IntegerConstant_ExecutableAspectIntegerConstantAspectProperties _self_ = org.gemoc.arduino.concurrent.xarduino.aspects.IntegerConstant_ExecutableAspectIntegerConstantAspectContext.getSelf(_self);
    Object result = null;
     if (_self instanceof org.gemoc.arduino.concurrent.xarduino.arduino.IntegerConstant){
    					result = org.gemoc.arduino.concurrent.xarduino.aspects.IntegerConstant_ExecutableAspect._privk3_evaluate(_self_, (org.gemoc.arduino.concurrent.xarduino.arduino.IntegerConstant)_self);
