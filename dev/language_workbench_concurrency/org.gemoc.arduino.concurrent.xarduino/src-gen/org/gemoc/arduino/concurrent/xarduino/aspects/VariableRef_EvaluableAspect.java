...
public class VariableRef_EvaluableAspect extends Expression_EvaluableAspect {
  ...
  public static Object evaluate(final VariableRef _self) {
    final org.gemoc.arduino.concurrent.xarduino.aspects.VariableRef_EvaluableAspectVariableRefAspectProperties _self_ = org.gemoc.arduino.concurrent.xarduino.aspects.VariableRef_EvaluableAspectVariableRefAspectContext.getSelf(_self);
    Object result = null;
     if (_self instanceof org.gemoc.arduino.concurrent.xarduino.arduino.VariableRef){
    					result = org.gemoc.arduino.concurrent.xarduino.aspects.VariableRef_EvaluableAspect._privk3_evaluate(_self_, (org.gemoc.arduino.concurrent.xarduino.arduino.VariableRef)_self);
