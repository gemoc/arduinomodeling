...
import org.gemoc.arduino.concurrent.xarduino.aspects.BooleanVariable_EvaluableAspectBooleanVariableAspectProperties;
...
public class BooleanVariable_EvaluableAspect extends Variable_EvaluableAspect {
  ...
  public static Object evaluate(final BooleanVariable _self) {
    final org.gemoc.arduino.concurrent.xarduino.aspects.BooleanVariable_EvaluableAspectBooleanVariableAspectProperties _self_ = org.gemoc.arduino.concurrent.xarduino.aspects.BooleanVariable_EvaluableAspectBooleanVariableAspectContext.getSelf(_self);
    Object result = null;
     if (_self instanceof org.gemoc.arduino.concurrent.xarduino.arduino.BooleanVariable){
    					result = org.gemoc.arduino.concurrent.xarduino.aspects.BooleanVariable_EvaluableAspect._privk3_evaluate(_self_, (org.gemoc.arduino.concurrent.xarduino.arduino.BooleanVariable)_self);
