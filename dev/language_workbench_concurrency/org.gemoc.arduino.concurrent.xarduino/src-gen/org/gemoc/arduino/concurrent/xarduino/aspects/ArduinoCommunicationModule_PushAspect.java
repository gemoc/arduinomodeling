...
public abstract class ArduinoCommunicationModule_PushAspect {
  ...
  public static void push(final ArduinoCommunicationModule _self) {
    final org.gemoc.arduino.concurrent.xarduino.aspects.ArduinoCommunicationModule_PushAspectArduinoCommunicationModuleAspectProperties _self_ = org.gemoc.arduino.concurrent.xarduino.aspects.ArduinoCommunicationModule_PushAspectArduinoCommunicationModuleAspectContext.getSelf(_self);
     if (_self instanceof org.gemoc.arduino.concurrent.xarduino.arduino.BluetoothTransceiver){
    					org.gemoc.arduino.concurrent.xarduino.aspects.BluetoothTransceiver_PushAspect.push((org.gemoc.arduino.concurrent.xarduino.arduino.BluetoothTransceiver)_self);
    } else  if (_self instanceof org.gemoc.arduino.concurrent.xarduino.arduino.ArduinoCommunicationModule){
    					org.gemoc.arduino.concurrent.xarduino.aspects.ArduinoCommunicationModule_PushAspect._privk3_push(_self_, (org.gemoc.arduino.concurrent.xarduino.arduino.ArduinoCommunicationModule)_self);
